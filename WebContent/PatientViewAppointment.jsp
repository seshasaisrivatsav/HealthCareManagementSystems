...
<body>
 <div style="text-align:center;">
  <h2 style="display:inline;" >    Patient <s:property value="usertype" /> Appointment View   </h2>
</div>
 <s:actionerror />
  <tbody>
    <s:form action="PtAppt.action" method="post">
      <s:hidden  value="%{AppointmentDate}" name="AppointmentDate" />
       <s:hidden  value="%{PatientSSN}" name="PatientSSN" />
     <sx:datetimepicker name="AppointmentDate" key="label.dateofappt"  
